		...
		function wp_major_cta_update_notice(){
		    ...
		    if ( ! get_user_meta($user_id, 'wp_cta_major_update_ignore') ) {
		             ...
		             Sounds good! Hide This Message
		             	...
		             	<p>Please visit and re-save your current call to action templates. There were a number of necessary changes to the plugin to make it much much better! New to the plugin? <a href="http://docs.inboundnow.com/guide/how-to-place-calls-to-action/">Learn how to use it here.</a></p>
